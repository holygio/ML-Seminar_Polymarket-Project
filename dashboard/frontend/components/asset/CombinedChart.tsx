        ...
        <div style={{ height: '280px', width: '100%' }}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={stockSeries}>
              ...
              <CartesianGrid stroke="#2a3f58" strokeDasharray="1 0" />
              <XAxis dataKey="label" stroke="#2a3f58" fontSize={9} tickMargin={10} minTickGap={18} axisLine={false} tickLine={false} tick={{ fill: '#4a6080' }} />
              <YAxis
                stroke="#2a3f58"
                fontSize={9}
                domain={['auto', 'auto']}
              ...
              <Tooltip
                ...
                contentStyle={{ background: '#152237', border: '1px solid #243550', color: '#e2e8f0' }}
              />
