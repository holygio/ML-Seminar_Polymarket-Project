...
export default function TrueSentimentPanel({ tsData }: { tsData: SentimentPoint[] | undefined }) {
  ...
  return (
    <div style={{ marginBottom: '32px' }}>
      ...
      <div style={{ width: '100%' }}>
        <div style={{ display: 'flex', height: '12px', background: '#111e30', position: 'relative' }}>
          <div style={{ width: '50%', background: 'linear-gradient(to right, #111e30, #243550)' }} />
          <div style={{ width: '50%', background: 'linear-gradient(to right, #243550, #22c55e)' }} />
